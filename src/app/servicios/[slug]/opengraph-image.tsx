...
export const alt = 'Familia Internacional - Servicio jurídico';
...
export default async function ServiceOgImage({ params }: ServiceOgImageProps) {
  ...
  const title = landing?.title ?? 'Servicio jurídico';
  const description =
    landing?.seoDescription ??
    'Asesoría jurídica especializada en derecho internacional de familia en Chile.';
  const eyebrow = landing?.eyebrow ?? 'Familia Internacional';
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: '#ffffff' }}>Familia Internacional</span>
          </div>
          <div
            style={{
