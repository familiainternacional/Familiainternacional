...
export default function ReplicaHero() {
  ...
  return (
    <section 
      className="relative w-full pb-8 pt-[8.75rem] sm:pb-10 sm:pt-[9.5rem] lg:pb-12 lg:pt-[104px] xl:pb-12 xl:pt-[104px] bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <div className={`relative z-10 ${SITE_CONTAINER_CLASS}`}>
        <div
          id="home"
          className={`relative w-full overflow-hidden rounded-[1.75rem] border border-white/50 bg-white/85 backdrop-blur-lg shadow-[0_30px_80px_rgba(0,0,0,0.2)] sm:rounded-[2rem] xl:rounded-[2.25rem] scroll-mt-[8.75rem] sm:scroll-mt-[9.5rem] lg:scroll-mt-[9rem]`}
        >
          <div className="grid lg:min-h-[580px] lg:grid-cols-2 lg:items-stretch xl:min-h-[620px]">
            <div className="flex h-full min-h-0 flex-col justify-center px-5 py-6 sm:px-8 sm:py-10 lg:justify-between lg:px-10 lg:py-12 xl:px-14 xl:py-12 2xl:px-16">
              <div className="space-y-3 sm:space-y-4 lg:space-y-5 flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <h1 className="text-[1.65rem] leading-[1.15] sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[#111827] xl:leading-tight">
                ...
                <p className="max-w-2xl text-sm font-medium leading-relaxed text-[#4b5563] sm:text-base lg:max-w-none lg:text-[1.0625rem] lg:leading-7 xl:max-w-xl">
              ...
              <div className="mt-6 w-full sm:mt-10 lg:mb-8 lg:mt-0 flex flex-col gap-3 sm:gap-4 items-center lg:items-start">
                <BookCallButton
